    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 140f, 6.1f, "Benzin", 150, "1.5 TSI" },
                    { 2, 124f, 5.4f, "Benzin(mild) Hybrid", 150, "1.5 eTSI" },
                    { 3, 128f, 4.8f, "Gázolaj", 150, "2.0 TDI" },
                    { 4, 6f, 0.3f, "Kombinált: benzin és elektromotor", 150, "1.5 TSI Plug-In-Hybrid" },
                    { 5, 170f, 7.5f, "Benzin", 265, "2.0 TSI" },
                    { 6, 180f, 7.9f, "Benzin", 300, "2.0 TSI" },
                    { 7, 192f, 8.5f, "Benzin", 333, "2.0 TSI" },
                    { 10, 136f, 6f, "Benzin", 115, "1.5 TSI" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kézi 6 fokozatú", " Elsőkerék hajtás" },
                    { 2, "DSG váltó 7 fokozatú", " Elsőkerék hajtás" },
                    { 3, "DSG váltó 6 fokozatú", " Elsőkerék hajtás" },
                    { 4, "DSG váltó 7 fokozatú", "Összkerék hajtás" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2025, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@admin.com", "admin01", "admin" },
                    { 7, new DateTime(2025, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "nagybela01@gmail.com", "bela01", "nbela007" },
                    { 8, new DateTime(2025, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "kissjanos@gmail.com", "janos1", "kjanos" }
                });
