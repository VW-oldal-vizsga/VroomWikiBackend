...
namespace VroomWiki.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreatedAt", "Email", "Password", "PasswordHash" },
                values: new object[,]
                {
                    { 7, new DateTime(2025, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@admin.com", "admin01", null },
                    { 8, new DateTime(2025, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "nagybela01@gmail.com", "bela01", null },
                    { 9, new DateTime(2025, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "kissjanos@gmail.com", "janos1", null }
                });
